...
{
  "image": "network-diagram.png",
  "correctRegions": [{"x": 250, "y": 180, "width": 100, "height": 50, "label": "DMZ"}]
}
```
""",
    ),
    (
        "err_hotspot_no_regions",
        """---
type: HOTSPOT
---
...
{
  "image": "a.png",
  "correctRegions": [{"label": "no coords"}, {"points": [[0, 0], [1, 1]]}, {"x": "0.1", "y": 0.1, "width": 0.2, "height": 0.2}],
  "distractorRegions": "nope"
}
```
""",
    ),
